...
public class MiReceta extends AppCompatActivity {
    ...
    public void cerrar(View v){
        Intent i = new Intent(MiReceta.this, Inicio.class);
        startActivity(i);
    }

    //    metodo para ir a editar usuario
    public void irEditarUsuario(View v){
        Intent i = new Intent(MiReceta.this, EditarUsuario.class);
        startActivity(i);
    }
...
//        capturar id del item
        ...
        if(id == R.id.opcCerrar){
            cerrar(null);
            Toast.makeText(MiReceta.this, "Sesión cerrada", Toast.LENGTH_LONG).show();
            return true;
        }
