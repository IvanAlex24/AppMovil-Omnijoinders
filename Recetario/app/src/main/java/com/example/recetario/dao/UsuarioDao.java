...
public class UsuarioDao {
    ...
    final private String CAMBIO = "UPDATE USUARIOS SET USUARIO = ?, CONTRASENA = ? WHERE ID_USUARIO = ?";
    ...
    public void Actualizar(Context context, Usuario usuario){
        ...
        s.clearBindings();
        s.bindString(1, usuario.getUsuario());
        s.bindString(2,usuario.getContrasena());
        s.bindLong(3,usuario.getIdUsuario());
